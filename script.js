...
characters.push(...[
  ...
  ['Hanabi Hyûga', 'Héritière Hyûga', 'Konoha', '白', 'H', '#8d98ad', 'Sœur cadette d’Hinata, Hanabi est une héritière talentueuse du Byakugan et une combattante déterminée du clan Hyûga.', ['Hyûga', 'Byakugan', 'Jûken'], [['Hanabi vs Hinata', 'Enfance'], ['Hanabi vs Boruto', 'Boruto'], ['Hanabi vs Toneri', 'The Last']]],
  ['Hiashi Hyûga', 'Chef du clan Hyûga', 'Konoha', '八', 'H', '#8295a2', 'Père de Hinata et Hanabi, Hiashi dirige le clan Hyûga et apprend à dépasser les divisions entre branche principale et secondaire.', ['Hyûga', 'Byakugan', 'Jûken'], [['Hiashi vs Hizashi', 'Affaire Kumo'], ['Hiashi vs Zetsu Blanc', 'Quatrième grande guerre'], ['Hiashi & Hanabi vs Toneri', 'The Last']]],
...
characters.push(...[
  ...
  ['Kidômaru', 'Cinq du Son', 'Otogakure', '蛛', 'K', '#88736d', 'Combattant araignée des Cinq du Son, Kidômaru mise sur les pièges, les toiles et les tirs à longue portée.', ['Otogakure', 'Araignée', 'Cinq du Son'], [['Kidômaru vs Neji', 'Mission de récupération'], ['Kidômaru vs Shikamaru', 'Mission de récupération'], ['Kidômaru vs Orochimaru', 'Otogakure']]],
...
characters.push(...[
  ...
  ['Himawari Uzumaki', 'Ninja de Konoha', 'Konoha', '向', 'H', '#d2a95d', 'Fille de Naruto et Hinata, Himawari hérite du Byakugan et devient le réceptacle de Kurama dans Two Blue Vortex.', ['Uzumaki', 'Byakugan', 'Kurama'], [['Himawari vs Jura', 'Two Blue Vortex'], ['Himawari vs Boruto', 'Konoha'], ['Himawari vs Delta', 'Boruto']]],
...
function openBattleModal(battle, character) {
  ...
  const singaporeVideoUrl = `https://www.youtube.com/results?search_query=${encodeURIComponent(searchQuery)}&gl=SG&hl=fr`;
  document.querySelector('#modal-youtube').href = singaporeVideoUrl;
  document.querySelector('#modal-youtube').textContent = `VOIR LES VIDÉOS DISPONIBLES À SINGAPOUR ↗`;
